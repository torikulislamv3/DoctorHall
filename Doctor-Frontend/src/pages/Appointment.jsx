...
//     const { doctors, currencySymble, backendUrl, token, getDoctorsData } = useContext(AppContext)
...
export default function Appointment() {
    const { docId } = useParams();
    const { doctors, currencySymble, backendUrl, token, userData, getDoctorsData } = useContext(AppContext);
    const navigate = useNavigate();
    ...
    const daysOfWeek = ['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Satu'];
        ...
        try {
            ...
            const { data } = await axios.post(backendUrl + '/api/user/book-appointment', 
                { 
                    ...
                    slotTime, 
                    userData, 
                    userId: userData._id // Pass userId correctly here
                },
                {
                    headers: {
                        Authorization: `Bearer ${token}`
