...
export const initiateSSLPayment = async (req, res) => {
  ...
  const data = {
    ...
    fail_url: "https://doctorhall-doctor-backend.onrender.com/api/payment/fail",
    cancel_url: "https://doctor-frontend-v2x6.onrender.com/cancel",
    ipn_url: "https://doctorhall-doctor-backend.onrender.com/api/payment/ipn",
    shipping_method: "No",
